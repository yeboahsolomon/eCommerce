...
export default function Home() {
  ...
  const { data: productsData, isLoading: productsLoading } = useQuery({
    ...
    queryFn: async () => {
        const res = await api.getProducts({ limit: 8, sortBy: 'createdAt', order: 'desc' });
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="bg-yellow-400 text-yellow-900 text-[10px] font-extrabold px-2 py-0.5 rounded-full uppercase animate-pulse">Live</span>
              </div>
